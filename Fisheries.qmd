...
The dataset is from a [3rd year project for BIO3017S]{.underline}.
...
License of the data set? - Email Colin/Speak to him on camp

What is the source?

```{r}
fdat <- read.csv("RAW_Data/P_blochii_Project1.csv")
```
...
t.test(fem$TL, male$TL, conf.level = 0.95 )
summary(fem$TL)
